...
window.SITE_CONTENT = {
  ...
  "treasureHunt": {
    ...
    "clues": [
      ...
      "Open home page and find make a wish button (One more gift is waiting for u in blr)",
      ...
      "Something that holds your waist stronger than me.",
      "Something you kept saying you wanted to start — for so long.",
      "Look at this on your worst days. Seriously, just look at it.",
      "For feelings that are too big for a text message. A kit for the words you don't say out loud.",
      "Cute little things to help you write those memories.",
      "A cute little guy whose only job is to erase your mistakes.",
      "They won't say a word, but they'll stick around and make everything cuter.",
      "If you assemble this, you will see a cute person.",
      "Small enough to carry anywhere. Useful exactly when you need it most.",
      "It does two things. You'll figure out both when you open it.",
      "To add more beauty to your beauty.",
      "For the days that are harder than others — this stays with you even when I can't.",
      "Open one when you're happy. Open one when you're not. They're all for you.",
      "Plug it in. Watch something light up.",
      "Soft, round, and made for 2am hugs. It resemble your fav person",
      "Something you once said you would even use for drinking water.",
      "Messages from your favourite people!"
    ],
